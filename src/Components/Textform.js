  ...
  return (
    <><>
        <div className="container my-2" style={{color: props.mode==='dark' ? 'white':'black'}}>
            ...
            <button className="btn btn-outline-primary mx-2 my-2" onClick={HandleUpClick}>Convert to Upper</button>
            <button className="btn btn-outline-primary mx-2 my-2" onClick={HandleLowClick}>Convert to Lower</button>
            <button className="btn btn-outline-primary mx-2 my-2" onClick={HandleSpaceClick}>Remove Space</button>
            <button className="btn btn-outline-primary mx-2 my-2" onClick={HandleClearClick}>Clear Text</button>
        </div>
      </>
